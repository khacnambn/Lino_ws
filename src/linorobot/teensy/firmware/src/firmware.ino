...
Encoder motor1_encoder(MOTOR1_ENCODER_A, MOTOR1_ENCODER_B, COUNTS_PER_REV, true);
Encoder motor2_encoder(MOTOR2_ENCODER_A, MOTOR2_ENCODER_B, COUNTS_PER_REV); 
Encoder motor3_encoder(MOTOR3_ENCODER_A, MOTOR3_ENCODER_B, COUNTS_PER_REV, true); 
...
// #define MOTOR2_ENCODER_A 13 //21
// #define MOTOR2_ENCODER_B 12 //20
...
//   #define MOTOR4_PWM 9
//   #define MOTOR4_IN_A 10 //10
//   #define MOTOR4_IN_B 11 //11

//   #define PWM_MAX pow(2, PWM_BITS) - 1
//   #define PWM_MIN -PWM_MAX

// // Target RPM for testing
//   #define TEST_RPM 150
...
//     delay(1000); // Delay to allow stabilization
//     // Set each motor to the desired RPM (150 RPM)
//     motor1_controller.spin(TEST_RPM);
//     motor2_controller.spin(TEST_RPM);
//     motor3_controller.spin(TEST_RPM);
//     motor4_controller.spin(TEST_RPM);
    
//     delay(1000);
    
//     // motor1_controller.spin(150);
//     // motor2_controller.spin(150);
//     // motor3_controller.spin(150);
//     // motor4_controller.spin(150);
