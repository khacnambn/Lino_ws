...
#define K_P 0.325 // P constant
#define K_I 0.025 // I constant
#define K_D 0.1 // D constant

//define your robot' specs here
#define MAX_RPM 250               // motor's maximum RPM
#define COUNTS_PER_REV 894      //884 // wheel encoder's no of ticks per rev
...
#define FR_WHEELS_DISTANCE 0.2015   // distance between front and rear wheels. Ignore this if you're on 2WD/ACKERMANN
